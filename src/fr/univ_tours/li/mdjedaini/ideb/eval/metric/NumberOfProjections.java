...
public class NumberOfProjections extends Metric {

	public NumberOfProjections(BenchmarkEngine arg_be) {
		super(arg_be);
		this.name           = "Metric - Number of projections";
        this.description    = "Number of projections in the current SQL query.";
	}
	...
	public MetricScore apply(Exploration arg_tr) {
        ...
        for(Query q_tmp : workSession.getQueryList()) {
            ...
            queryScoreList.add(new Double(qt.getProjectionList().size()));
        }
