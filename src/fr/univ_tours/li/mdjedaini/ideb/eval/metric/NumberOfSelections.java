...
public class NumberOfSelections extends Metric {
	public NumberOfSelections(BenchmarkEngine arg_be) {
		super(arg_be);
		this.name           = "Metric - Number of selections";
        this.description    = "Number of selections in the current SQL query.";
	}
	...
	public MetricScore apply(Exploration arg_tr) {
        ...
        for(Query q_tmp : workSession.getQueryList()) {
            ...
            queryScoreList.add(new Double(qt.getSelectionList().size()));
        }
